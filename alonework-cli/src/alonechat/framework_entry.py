...
1. 基本使用 - Basic Usage:
   from alonechat.framework_entry import Agent
   agent = Agent()
   result = agent.run("帮我写一个Python函数")

2. 指定模式 - Specify Mode:
   from alonechat.framework_entry import Agent, ExecutionMode
...
from alonechat.framework_config import get_config, AgentConfig
