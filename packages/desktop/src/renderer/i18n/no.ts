export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av AloneWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av AloneWork er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'AloneWork'-kommandoen.",
