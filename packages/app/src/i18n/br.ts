export const dict = {
  ...
  "dialog.provider.AloneWork.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.AloneWork.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.AloneWorkGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo AloneWork",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no AloneWork.",
  ...
  "provider.connect.AloneWorkZen.line1":
    "AloneWork Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.AloneWorkZen.visit.prefix": "Visite ",
  "provider.connect.AloneWorkZen.visit.link": "AloneWork.ai/zen",
  "provider.connect.AloneWorkZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no AloneWork.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no AloneWork.",
  ...
  "dialog.plugins.empty": "Plugins configurados em AloneWork.json",
  ...
  "dialog.server.description": "Trocar para qual servidor AloneWork este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do AloneWork ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do AloneWork",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (AloneWork.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: AloneWork ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "AloneWork inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor AloneWork dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do AloneWork",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o AloneWork aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o AloneWork segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o AloneWork é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o AloneWork iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do AloneWork.",
