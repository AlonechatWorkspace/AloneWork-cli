export const dict = {
  ...
  "dialog.provider.AloneWork.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.AloneWork.tagline": "Modelos optimizados y fiables",
  "dialog.provider.AloneWorkGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por AloneWork",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en AloneWork.",
  ...
  "provider.connect.AloneWorkZen.line1":
    "AloneWork Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.AloneWorkZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.AloneWorkZen.visit.prefix": "Visita ",
  "provider.connect.AloneWorkZen.visit.link": "AloneWork.ai/zen",
  "provider.connect.AloneWorkZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en AloneWork.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en AloneWork.",
  ...
  "dialog.plugins.empty": "Plugins configurados en AloneWork.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de AloneWork se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de AloneWork ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de AloneWork",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (AloneWork.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, AloneWork no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "AloneWork incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor AloneWork dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para AloneWork",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve AloneWork en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si AloneWork sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de AloneWork.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia AloneWork",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de AloneWork.",
