export const dict = {
  ...
  "dialog.provider.AloneWork.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.AloneWork.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.AloneWorkGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AloneWork",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AloneWork.",
  ...
  "provider.connect.AloneWorkZen.line1":
    "AloneWork Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.AloneWorkZen.visit.prefix": "Odwiedź ",
  "provider.connect.AloneWorkZen.visit.link": "AloneWork.ai/zen",
  "provider.connect.AloneWorkZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w AloneWork.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AloneWork.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w AloneWork.json",
  ...
  "dialog.server.description": "Przełącz serwer AloneWork, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja AloneWork ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AloneWork",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (AloneWork.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "AloneWork zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AloneWork",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd AloneWork na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AloneWork ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AloneWork.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AloneWork",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AloneWork.",
