export const dict = {
  ...
  "dialog.provider.AloneWork.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.AloneWork.tagline": "Modèles optimisés et fiables",
  "dialog.provider.AloneWorkGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par AloneWork",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans AloneWork.",
  ...
  "provider.connect.AloneWorkZen.line1":
    "AloneWork Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.AloneWorkZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.AloneWorkZen.visit.prefix": "Visitez ",
  "provider.connect.AloneWorkZen.visit.link": "AloneWork.ai/zen",
  "provider.connect.AloneWorkZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans AloneWork.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans AloneWork.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans AloneWork.json",
  ...
  "dialog.server.description": "Changez le serveur AloneWork auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'AloneWork ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe AloneWork",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (AloneWork.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'AloneWork ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "AloneWork inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "AloneWork Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur AloneWork dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour AloneWork",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'AloneWork sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si AloneWork suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'AloneWork.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'AloneWork",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'AloneWork.",
