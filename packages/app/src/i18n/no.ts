...
export const dict = {
  ...
  "dialog.provider.AloneWork.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.AloneWork.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.AloneWorkGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av AloneWork",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i AloneWork.",
  ...
  "provider.connect.AloneWorkZen.line1":
    "AloneWork Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.AloneWorkZen.visit.prefix": "Besøk ",
  "provider.connect.AloneWorkZen.visit.link": "AloneWork.ai/zen",
  "provider.connect.AloneWorkZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i AloneWork.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i AloneWork.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i AloneWork.json",
  ...
  "dialog.server.description": "Bytt hvilken AloneWork-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av AloneWork ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til AloneWork-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (AloneWork.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at AloneWork ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "AloneWork inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør AloneWork-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for AloneWork",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan AloneWork ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om AloneWork skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan AloneWork er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når AloneWork starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av AloneWork.",
