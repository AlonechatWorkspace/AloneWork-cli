export const dict = {
  ...
  "dialog.provider.AloneWork.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.AloneWork.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.AloneWorkGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af AloneWork",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i AloneWork.",
  ...
  "provider.connect.AloneWorkZen.line1":
    "AloneWork Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.AloneWorkZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.AloneWorkZen.visit.prefix": "Besøg ",
  "provider.connect.AloneWorkZen.visit.link": "AloneWork.ai/zen",
  "provider.connect.AloneWorkZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i AloneWork.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i AloneWork.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i AloneWork.json",
  ...
  "dialog.server.description": "Skift hvilken AloneWork-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af AloneWork ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til AloneWork-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (AloneWork.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, AloneWork understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "AloneWork inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør AloneWork-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for AloneWork",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan AloneWork ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om AloneWork følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan AloneWork er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når AloneWork starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af AloneWork.",
