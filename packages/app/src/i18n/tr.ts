...
export const dict = {
  ...
  "dialog.provider.AloneWork.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.AloneWork.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.AloneWorkGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "AloneWork tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve AloneWork'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.AloneWorkZen.line1":
    "AloneWork Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.AloneWorkZen.visit.prefix": "",
  "provider.connect.AloneWorkZen.visit.link": "AloneWork.ai/zen",
  "provider.connect.AloneWorkZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve AloneWork'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak AloneWork'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler AloneWork.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi AloneWork sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "AloneWork'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AloneWork ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (AloneWork.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: AloneWork henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "AloneWork ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "AloneWork Masaüstü",
  ...
  "settings.desktop.wsl.description": "AloneWork sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "AloneWork'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "AloneWork'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "AloneWork'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "AloneWork'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "AloneWork başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "AloneWork'un en son sürümünü kullanıyorsunuz.",
