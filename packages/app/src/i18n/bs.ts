export const dict = {
  ...
  "dialog.provider.AloneWork.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.AloneWork.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.AloneWorkGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje AloneWork",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u AloneWork-u.",
  ...
  "provider.connect.AloneWorkZen.line1":
    "AloneWork Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.AloneWorkZen.visit.prefix": "Posjeti ",
  "provider.connect.AloneWorkZen.visit.link": "AloneWork.ai/zen",
  "provider.connect.AloneWorkZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u AloneWork-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u AloneWork-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u AloneWork.json",
  ...
  "dialog.server.description": "Promijeni na koji se AloneWork server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija AloneWork-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku AloneWork timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (AloneWork.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: AloneWork još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AloneWork uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni AloneWork server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u AloneWork-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako AloneWork izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li AloneWork prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu AloneWork-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se AloneWork pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju AloneWork-a.",
