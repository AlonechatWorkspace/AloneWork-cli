...
import compareVideo from "../../asset/lander/AloneWork-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/AloneWork-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="AloneWork:auth" content={loggedin() ? "true" : "false"} />
