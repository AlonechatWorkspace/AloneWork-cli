...
<html>
  <head>
    <title>AloneWork - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to AloneWork.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>AloneWork - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
