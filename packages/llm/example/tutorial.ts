 ...
 *
 * Run from `packages/llm` with a DeepSeek key in the environment:
 *
 *   DEEPSEEK_API_KEY=... bun example/tutorial.ts
 *
...
const apiKey = Config.redacted("DEEPSEEK_API_KEY")
...
const model = OpenAICompatible.deepseek.configure({
  apiKey,
